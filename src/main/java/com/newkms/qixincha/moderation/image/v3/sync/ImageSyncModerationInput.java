package com.newkms.qixincha.moderation.image.v3.sync;
...
public class ImageSyncModerationInput extends BizPostJsonRequest<ImageSyncModerationOutput> {
    ...
    public ImageSyncModerationInput(String businessId) {
        ...
        version = "v3";
        // 接口地址
        uriPattern = "/kms-open/v3/image/sync";
    }

    @Override
    public Class<ImageSyncModerationOutput> getResponseClass() {
        return ImageSyncModerationOutput.class;
    }
