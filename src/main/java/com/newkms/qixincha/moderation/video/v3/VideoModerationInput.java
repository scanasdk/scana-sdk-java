package com.newkms.qixincha.moderation.video.v3;
...
public class VideoModerationInput extends BizPostJsonRequest<VideoModerationOutput> {
    /**
     * 额外信息，会在响应/回调中返回
     */
     ...
     * 同步调用接口
     */
    public VideoModerationInput(String businessId) {
        this.businessId = businessId;
        // 版本号
        version = "v3";
        // 接口地址
        uriPattern = "/kms-open/v3/video/async";
    }

    @Override
    public Class<VideoModerationOutput> getResponseClass() {
        return VideoModerationOutput.class;
    }

    @Override
    public String toString() {
        return "VideoModerationInput{" +
                "extra='" + extra + '\'' +
                ", appId='" + appId + '\'' +
                ", secretKey='" + secretKey + '\'' +
                ", url='" + url + '\'' +
