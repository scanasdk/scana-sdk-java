...
2. pom.xml中引入
   ``````java
           <dependency>
               ...
               <version>3.0</version>
               <scope>system</scope>
               <systemPath>${project.basedir}/lib/scana-sdk-java.jar</systemPath>
           </dependency>
   ``````
...
```js
package com.newkms.qixincha.scanasdkjavademo;
...
```js
package com.newkms.qixincha.scanasdkjavademo.text;
 ...
 * 文本同步检测demo
 */
public class ModerationTextSyncClientDemo {
    ...
    ModerationClient client = new ModerationClient(appId, secretKey);
    // 实例化请求对象,传入业务ID
    TextSyncModerationInput textSyncModerationInput = new TextSyncModerationInput(businessId);
    // 设置检测内容
    textSyncModerationInput.setText(createTexts());
    // 响应结构体
 ...
 * 文本异步检测demo
 */
public class ModerationTextAsyncClientDemo {
    private static final String secretKey = "secretKey";
    private static final String appId = "appId";
    private static final String businessId = "businessId";
    ...
    ModerationClient client = new ModerationClient(appId, secretKey);
    // 实例化请求对象,传入业务ID
    TextAsyncModerationInput textAsyncModerationInput = new TextAsyncModerationInput(businessId);
    // 设置检测内容
    textAsyncModerationInput.setText(createTexts());
    // 检测结果
 ...
 * 图像异步检测demo
 */
public class ModerationImageAsyncClientTest {
    private static final String secretKey = "secretKey";
    private static final String appId = "appId";
    private static final String businessId = "businessId";
    ...
    System.out.printf("响应码 :%d\n", resp.getCode());
    System.out.printf("响应信息 :%s\n", resp.getMessage());
    System.out.printf("图片检测类别 :%d", resp.getModerationType());
} catch (Exception e) {
    e.printStackTrace();
}
}
...
```js
package com.newkms.qixincha.scanasdkjavademo.audio;
 ...
 * 音频异步检测demo
 */
public class ModerationAudioAsyncClientTest {
    private static final String secretKey = "secretKey";
    private static final String appId = "appId";
    private static final String businessId = "businessId";
    ...
    // 检测音频地址
    audioModerationInput.setUrl("https://files-rs.zsxq.com/lpAtQmTCJ8YKCVXFueVSncMSOL8C?attname=%E9%A3%8E%E7%94%B5%26%E7%94%B5%E7%BD%91%E5%91%A8%E5%BA%A6%E6%95%B0%E6%8D%AE%E4%B8%8E%E8%A7%82%E7%82%B9%E6%B1%87%E6%8A%A5+231007.mp3&e=1712308798&token=kIxbL07-8jAj8w1n4s9zv64FuZZNEATmlU_Vm6zD:CVP8s58Shu7CbIZmom8l_JFOlG4=");
    // 检测内容ID
...
```js
package com.newkms.qixincha.scanasdkjavademo.video;
 ...
 * 视频异步检测demo
 */
public class ModerationVideoAsyncClientTest {
    private static final String secretKey = "secretKey";
    private static final String appId = "appId";
    private static final String businessId = "businessId";
...
```js
package com.newkms.qixincha.scanasdkjavademo.doc;
 ...
 * 文档异步检测demo
 */
public class ModerationDocAsyncClientTest {
    private static final String secretKey = "secretKey";
    private static final String appId = "appId";
    private static final String businessId = "businessId";
    ...
    // 检测文档地址
    docModerationInput.setUrl("https://files-rs.zsxq.com/lpAtQmTCJ8YKCVXFueVSncMSOL8C?attname=%E9%A3%8E%E7%94%B5%26%E7%94%B5%E7%BD%91%E5%91%A8%E5%BA%A6%E6%95%B0%E6%8D%AE%E4%B8%8E%E8%A7%82%E7%82%B9%E6%B1%87%E6%8A%A5+231007.mp3&e=1712308798&token=kIxbL07-8jAj8w1n4s9zv64FuZZNEATmlU_Vm6zD:CVP8s58Shu7CbIZmom8l_JFOlG4=");
    // 检测内容ID
    docModerationInput.setContentId("test-audio");
